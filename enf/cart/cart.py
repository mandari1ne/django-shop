...
# ДЛЯ СЕССИОННОЙ КОРЗИНЫ, У НАС НА ОСНОВЕ БД
...
#
#     def save(self):
#         # сигнал джанго, что произошли изменения в куках
...
#                 if cart_item['products_id'] == str(product.id):
#                     cart_item['product'] = product
#                     cart_item['total_price'] = Decimal(cart_item['price']) * cart['quantity']
#                     yield cart_item
#
#     def __len__(self):
